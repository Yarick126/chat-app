  ...
  <>
    ...
    <Form className='w-25 position-absolute top-50 start-50 translate-middle text-primary' onSubmit={handleSubmit(onSubmit)}>
      <Form.Group >
        ...
        <Form.Control id='firstName' {...register('firstName', {required:true})}></Form.Control>
      ...
      <Form.Group>
        ...
        <Form.Control id='secondName' {...register('secondName', {required: true})}></Form.Control>
        {errors.secondName && <Form.Text className='text-danger'>This field is required!</Form.Text>}
      </Form.Group>

      <Form.Group className='w-25'>
        <Form.Label htmlFor='age'>Age</Form.Label>
        <Form.Control type="number" id='age' {...register('age', {required: true})}></Form.Control>
      ...
      <Form.Group>
        ...
        <Form.Control type='password' id='password' {...register('password', {required: true})}></Form.Control>
      ...
      <Form.Group>
        ...
        <Form.Control type='password' id='repeatPassword' {...register('password', {required: true})}></Form.Control>
        {errors.password && <Form.Text className='text-danger'>This field is required!</Form.Text>}
      </Form.Group>
